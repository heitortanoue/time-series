...
from .differentiation import difference_time_series, difference_filter
...
def filter_and_plot_decomposition(time_series, lags=None, model:str = ['additive', 'multiplicative']):
    """
