...
def lvl_2_filter(lst:List[str]) -> List[str]:
    ...
    filters = (lvl_2['administrative_area_level_1'] + " - " + lvl_2['administrative_area_level_2']).drop_duplicates().sort_values()
    return filters
...
def lvl_3_filter(lst) -> List[str]:
    ...
    filters = (lvl_3['administrative_area_level_2'] + " - " + lvl_3['administrative_area_level_3']).sort_values()
    return filters
